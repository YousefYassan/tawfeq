...
def main(param):
    ...
    # session = requests.Session()  # Corrected this line
    ...
    for i in range(1,11):
        product_link = f'https://www.amazon.sa/s?i=electronics&rh=n%3A16966419031&fs=true&page={i}&language=en'
            ...
            try:
                ...
                if all_phones:
                    for phone in all_phones:
                        ...
                        phone_link = f"https://www.amazon.sa{phone_link}"
